...
interface EditImageModalProps {
  ...
  language: string;
  styleReferences: ImageResult[];
}

const EditImageModal: React.FC<EditImageModalProps> = ({ image, onClose, onApply, language, styleReferences }) => {
  ...
  const handleEdit = async () => {
    ...
    try {
        ...
        const newUrl = await editImage(prompt, { base64: base64Data, mimeType: mimeTypeMatch[1] }, language, styleReferences);
